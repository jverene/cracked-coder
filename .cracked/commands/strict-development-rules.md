...
- **Keyboard Handling**: Keyboard handling MUST go through `useKeyPress.ts` from
  the Cracked Coder package rather than the standard ink library. This library
...
## General Cracked Coder Design Principles
...
- **Prompts**: Be aware that changes can impact the prompts sent to Cracked Coder
