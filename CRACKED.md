...
- **Test Commands:**
  ...
  - **Workspace-Specific:** `npm test -w <pkg> -- <path>` (Note: `<path>` must
    ...
    `-w @google/cracked-coder-core -- src/routing/modelRouterService.test.ts`)
...
- **License Headers:** For all new source code files (`.ts`, `.tsx`, `.js`),
  ...
  `Copyright 2026 Cracked Coder LLC`). This is enforced by ESLint.
