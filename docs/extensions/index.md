...
Cracked Coder extensions package prompts, MCP servers, custom commands, themes,
hooks, sub-agents, and agent skills into a familiar and user-friendly format.
With extensions, you can expand the capabilities of Cracked Coder and share those
capabilities with others. They are designed to be easily installable and
shareable.

To see what's possible, browse the
[Cracked Coder extension gallery](https://geminicli.com/extensions/browse/).
...
Learn how to discover, install, and manage extensions to enhance your Cracked Coder
experience.
...
```bash
cracked extensions install https://github.com/cracked-coder-extensions/workspace
```
