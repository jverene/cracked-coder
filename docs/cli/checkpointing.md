...
The Cracked Coder includes a Checkpointing feature that automatically saves a
...
1.  **A Git snapshot:** A commit is made in a special, shadow Git repository
    located in your home directory (`~/.cracked/history/<project_hash>`). This
...
`~/.cracked/tmp/<project_hash>/checkpoints`.
