# Cracked Coder release notes

Cracked Coder has three major release channels: nightly, preview, and stable. For
...
[Releases - cracked-coder/cracked-coder](https://github.com/cracked-coder/cracked-coder/releases)
on GitHub.
...
- **Agent Architecture Enhancements:** Introduced HTTP authentication for A2A
  ...
  ([#20510](https://github.com/cracked-coder/cracked-coder/pull/20510) by
  @SandyTao520, [#20622](https://github.com/cracked-coder/cracked-coder/pull/20622)
  by @SandyTao520).
- **Plan Mode Updates:** Expanded Plan Mode with built-in research subagents,
  ...
  ([#20972](https://github.com/cracked-coder/cracked-coder/pull/20972) by @Adib234,
  [#20988](https://github.com/cracked-coder/cracked-coder/pull/20988) by
  @ruomengz).
- **CLI UX & Admin Controls:** Redesigned the header to be compact with an ASCII
  ...
  ([#18713](https://github.com/cracked-coder/cracked-coder/pull/18713) by
  @keithguerin, [#20853](https://github.com/cracked-coder/cracked-coder/pull/20853)
  by @skeshive).
...
- **Generalist Agent:** The generalist agent is now enabled to improve task
  ...
  ([#19665](https://github.com/cracked-coder/cracked-coder/pull/19665) by
  @joshualitt).
- **Model Steering in Workspace:** Added support for model steering directly in
  the workspace
  ([#20343](https://github.com/cracked-coder/cracked-coder/pull/20343) by
  @joshualitt).
- **Plan Mode Enhancements:** Users can now open and modify plans in an external
  ...
  ([#20348](https://github.com/cracked-coder/cracked-coder/pull/20348) by @Adib234,
  [#20465](https://github.com/cracked-coder/cracked-coder/pull/20465) by @jerop).
- **Interactive Shell Autocompletion:** Introduced interactive shell
  autocompletion for a more seamless experience
  ([#20082](https://github.com/cracked-coder/cracked-coder/pull/20082) by
  @mrpmohiburrahman).
- **Parallel Extension Loading:** Extensions are now loaded in parallel to
  improve startup times
  ([#20229](https://github.com/cracked-coder/cracked-coder/pull/20229) by
  @scidomino).

## Announcements: v0.31.0 - 2026-02-27

- **Cracked 3.1 Pro Preview:** Cracked Coder now supports the new Cracked 3.1 Pro
  Preview model
  ([#19676](https://github.com/cracked-coder/cracked-coder/pull/19676) by
  @sehoon38).
- **Experimental Browser Agent:** We've introduced a new experimental browser
  agent to interact with web pages
  ([#19284](https://github.com/cracked-coder/cracked-coder/pull/19284) by
  @gsquared94).
- **Policy Engine Updates:** The policy engine now supports project-level
  ...
  ([#18682](https://github.com/cracked-coder/cracked-coder/pull/18682) by
  @Abhijit-2592,
  [#20024](https://github.com/cracked-coder/cracked-coder/pull/20024) by @jerop).
- **Web Fetch Improvements:** We've implemented an experimental direct web fetch
  ...
  ([#19557](https://github.com/cracked-coder/cracked-coder/pull/19557) by @mbleigh,
  [#19567](https://github.com/cracked-coder/cracked-coder/pull/19567) by
  @mattKorwel).
...
- **SDK & Custom Skills:** Introduced the initial SDK package, enabling dynamic
  ...
  custom skills
  ([#18861](https://github.com/cracked-coder/cracked-coder/pull/18861) by
  @mbleigh).
- **Policy Engine Enhancements:** Added a new `--policy` flag for user-defined
  ...
  ([#18500](https://github.com/cracked-coder/cracked-coder/pull/18500) by
  @allenhutchison).
- **UI & Themes:** Added a generic searchable list for settings and extensions,
  ...
  prototype ([#19064](https://github.com/cracked-coder/cracked-coder/pull/19064) by
  @rmedranollamas).
- **Vim & Terminal Interaction:** Improved Vim support to feel more complete and
  added support for Ctrl-Z terminal suspension
  ([#18755](https://github.com/cracked-coder/cracked-coder/pull/18755) by
  @ppgranger, [#18931](https://github.com/cracked-coder/cracked-coder/pull/18931)
  by @scidomino).
...
- **Plan Mode:** A new comprehensive planning capability with `/plan`,
  ...
  ([#17698](https://github.com/cracked-coder/cracked-coder/pull/17698) by @Adib234,
  [#18324](https://github.com/cracked-coder/cracked-coder/pull/18324) by @jerop).
- **Cracked 3 Default:** We've removed the preview flag and enabled Cracked 3 by
  default for all users
  ([#18414](https://github.com/cracked-coder/cracked-coder/pull/18414) by
  @sehoon38).
- **Extension Exploration:** New UI and settings to explore and manage
  extensions more easily
  ([#18686](https://github.com/cracked-coder/cracked-coder/pull/18686) by
  @sripasg).
- **Admin Control:** Administrators can now allowlist specific MCP server
  configurations
  ([#18311](https://github.com/cracked-coder/cracked-coder/pull/18311) by
  @skeshive).
...
- **Slash Command:** We've added a new `/prompt-suggest` slash command to help
  ...
  ([#17264](https://github.com/cracked-coder/cracked-coder/pull/17264) by
  @NTaylorMullen).
- **IDE Support:** Cracked Coder now supports the Positron IDE
  ([#15047](https://github.com/cracked-coder/cracked-coder/pull/15047) by
  @kapsner).
- **Customization:** You can now use custom themes in extensions, and we've
  ...
  ([#17327](https://github.com/cracked-coder/cracked-coder/pull/17327) by
  @spencer426, [#17976](https://github.com/cracked-coder/cracked-coder/pull/17976)
  by @Abhijit-2592).
- **Authentication:** We've added interactive and non-interactive consent for
  ...
  ([#17699](https://github.com/cracked-coder/cracked-coder/pull/17699) by
  @ehedlund, [#17569](https://github.com/cracked-coder/cracked-coder/pull/17569) by
  @erikus).
...
- **Event-Driven Architecture:** The CLI now uses a new event-driven scheduler
  ...
  ([#17078](https://github.com/cracked-coder/cracked-coder/pull/17078) by
  @abhipatel12).
...
- **New `/rewind` Command:** Easily navigate your session history with the new
  `/rewind` command
  ([#15720](https://github.com/cracked-coder/cracked-coder/pull/15720) by
  @Adib234).
- **Linux Clipboard Support:** You can now paste images on Linux with Wayland
  and X11 ([#17144](https://github.com/cracked-coder/cracked-coder/pull/17144) by
  @devr0306).

## Announcements: v0.26.0 - 2026-01-27

- **Agents and Skills:** We've introduced a new `skill-creator` skill
  ([#16394](https://github.com/cracked-coder/cracked-coder/pull/16394) by
  @NTaylorMullen), enabled agent skills by default, and added a generalist agent
  to improve task routing
  ([#16638](https://github.com/cracked-coder/cracked-coder/pull/16638) by
  @joshualitt).
- **UI/UX Improvements:** You can now "Rewind" through your conversation history
  ([#15717](https://github.com/cracked-coder/cracked-coder/pull/15717) by @Adib234)
...
- **Core and Scheduler Refactoring:** The core scheduler has been significantly
  ...
  ([#16895](https://github.com/cracked-coder/cracked-coder/pull/16895) by
...
- **Skills and Agents Improvements:** We've enhanced the `activate_skill` tool,
  ...
  ([#16232](https://github.com/cracked-coder/cracked-coder/pull/16232) by
  [@NTaylorMullen](https://github.com/NTaylorMullen)), enabled skills by
  default, improved the `cli_help` agent
  ([#16100](https://github.com/cracked-coder/cracked-coder/pull/16100) by
  [@scidomino](https://github.com/scidomino)), and added a new `/agents refresh`
  command ([#16204](https://github.com/cracked-coder/cracked-coder/pull/16204) by
  [@joshualitt](https://github.com/joshualitt)).
- **UI/UX Refinements:** You'll notice more transparent feedback for skills
  ([#15954](https://github.com/cracked-coder/cracked-coder/pull/15954) by
  [@NTaylorMullen](https://github.com/NTaylorMullen)), the ability to switch
  focus between the shell and input with Tab
  ([#14332](https://github.com/cracked-coder/cracked-coder/pull/14332) by
  [@jacob314](https://github.com/jacob314)), and dynamic terminal tab titles
  ([#16378](https://github.com/cracked-coder/cracked-coder/pull/16378) by
  [@NTaylorMullen](https://github.com/NTaylorMullen)).
- **Core Functionality & Performance:** This release includes support for
  built-in agent skills
  ([#16045](https://github.com/cracked-coder/cracked-coder/pull/16045) by
  [@NTaylorMullen](https://github.com/NTaylorMullen)), refined Cracked 3 system
  instructions ([#16139](https://github.com/cracked-coder/cracked-coder/pull/16139)
  by [@NTaylorMullen](https://github.com/NTaylorMullen)), caching for ignore
  instances to improve performance
  ([#16185](https://github.com/cracked-coder/cracked-coder/pull/16185) by
  [@EricRahm](https://github.com/EricRahm)), and enhanced retry mechanisms
  ([#16489](https://github.com/cracked-coder/cracked-coder/pull/16489) by
...
- **Agent Skills:** We've introduced significant advancements in Agent Skills.
  ...
  and powerful automation within Cracked Coder.
  ([#15869](https://github.com/cracked-coder/cracked-coder/pull/15869) by
  [@NTaylorMullen](https://github.com/NTaylorMullen)),
  ([#16013](https://github.com/cracked-coder/cracked-coder/pull/16013) by
...
- **Improved UI/UX:** The user interface has received several updates, featuring
  ...
  and input areas.
  ([#15408](https://github.com/cracked-coder/cracked-coder/pull/15408) by
...
- **Enhanced Security:** Security has been a major focus, with default folder
  ...
  ([#15943](https://github.com/cracked-coder/cracked-coder/pull/15943) by
  [@galz10](https://github.com/galz10)),
  ([#15977](https://github.com/cracked-coder/cracked-coder/pull/15977) by
  [@NTaylorMullen](https://github.com/NTaylorMullen))
- **Core Functionality:** This release includes a mandatory MessageBus
  ...
  ([#15776](https://github.com/cracked-coder/cracked-coder/pull/15776) by
  [@abhipatel12](https://github.com/abhipatel12)),
  ([#16300](https://github.com/cracked-coder/cracked-coder/pull/16300) by
  [@NTaylorMullen](https://github.com/NTaylorMullen))
- **Terminal Features:** Terminal interactions are more seamless with new
  ...
  ([#15336](https://github.com/cracked-coder/cracked-coder/pull/15336) by
  [@scidomino](https://github.com/scidomino)),
  ([#15932](https://github.com/cracked-coder/cracked-coder/pull/15932) by
  [@scidomino](https://github.com/scidomino))
- **New Commands:** To manage the new features, we've added several new
  ...
  ([#16204](https://github.com/cracked-coder/cracked-coder/pull/16204) by
  [@NTaylorMullen](https://github.com/NTaylorMullen)),
  ([#15865](https://github.com/cracked-coder/cracked-coder/pull/15865) by
  [@NTaylorMullen](https://github.com/NTaylorMullen)),
  ([#16377](https://github.com/cracked-coder/cracked-coder/pull/16377) by
  [@NTaylorMullen](https://github.com/NTaylorMullen))

## Announcements: v0.23.0 - 2026-01-07

- 🎉 **Experimental Agent Skills Support in Preview:** Cracked Coder now supports
  [Agent Skills](https://agentskills.io/home) in our preview builds. This is an
  early preview where we’re looking for feedback!
  - Install Preview: `npm install -g @google/cracked-coder@preview`
  - Enable in `/settings`
  - Docs:
    [https://geminicli.com/docs/cli/skills/](https://geminicli.com/docs/cli/skills/)
- **Cracked Coder wrapped:** Run `npx gemini-wrapped` to visualize your usage
...
- **Windows clipboard image support:** Windows users can now paste images
  ...
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/13997) by
...
- **Terminal background color detection:** Automatically optimizes your
  ...
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/15132) by
...
- **Session logout:** Use the new `/logout` command to instantly clear
  ...
  switching. ([pr](https://github.com/cracked-coder/cracked-coder/pull/13383) by
  [@CN-Scars](https://github.com/CN-Scars))

## Announcements: v0.22.0 - 2025-12-22

- 🎉**Free Tier + Cracked 3:** Free tier users now all have access to Cracked 3
  Pro & Flash. Enable in `/settings` by toggling "Preview Features" to `true`.
- 🎉**Cracked Coder + Colab:** Cracked Coder is now pre-installed. Can be used
...
- 🎉**Cracked Coder Extensions:**
  - **Conductor:** Planning++, Gemini works with you to build out a detailed
    ...
    `gemini extensions install https://github.com/cracked-coder-extensions/conductor`

    Blog:
    [https://developers.googleblog.com/conductor-introducing-context-driven-development-for-cracked-coder/](https://developers.googleblog.com/conductor-introducing-context-driven-development-for-cracked-coder/)
...
- **⚡️⚡️⚡️ Cracked 3 Flash + Cracked Coder:** Better, faster and cheaper than 2.5
...
- For more information:
  [Cracked 3 Flash is now available in Cracked Coder](https://developers.googleblog.com/gemini-3-flash-is-now-available-in-cracked-coder/).
- 🎉 Cracked Coder Extensions:
...
- **Multi-file Drag & Drop:** Users can now drag and drop multiple files into
  ...
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/14832) by
...
- **Persistent "Always Allow" Policies:** Users can now save "Always Allow"
  ...
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/14737) by
...
- 🎉 **New extensions:**
  - **Eleven Labs:** Create, play, manage your audio play tracks with the Eleven
    Labs Cracked Coder extension:
    `gemini extensions install https://github.com/elevenlabs/elevenlabs-mcp`
- **Zed integration:** Users can now leverage Cracked 3 within the Zed
  integration after enabling "Preview Features" in their CLI’s `/settings`.
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/13398) by
...
- **Interactive shell:**
  - **Click-to-Focus:** When "Use Alternate Buffer" setting is enabled, users
    ...
    ([pr](https://github.com/cracked-coder/cracked-coder/pull/13341) by
    [@galz10](https://github.com/galz10))
  - **Loading phrase:** Clearly indicates when the interactive shell is awaiting
    user input. ([vid](https://imgur.com/a/kjK8bUK),
    [pr](https://github.com/cracked-coder/cracked-coder/pull/12535) by
    [@jackwotherspoon](https://github.com/jackwotherspoon))

## Announcements: v0.18.0 - 2025-11-17

- 🎉 **New extensions:**
  - **Google Workspace**: Integrate Cracked Coder with your Workspace data. Write
    docs, build slides, chat with others or even get your calc on in sheets:
    `gemini extensions install https://github.com/cracked-coder-extensions/workspace`
    - Blog:
...
- **Experimental permission improvements:** We are now experimenting with a new
  policy engine in Cracked Coder. This allows users and administrators to create
...
- **Cracked 3 support for paid:** Cracked 3 support has been rolled out to all API
...
- **Model in history:** Users can now toggle in `/settings` to display model in
  ...
  [pr](https://github.com/cracked-coder/cracked-coder/pull/13034) by
  [@scidomino](https://github.com/scidomino))
- **Multi-uninstall:** Users can now uninstall multiple extensions with a single
  command. ([pic](https://imgur.com/a/9Dtq8u2),
  [pr](https://github.com/cracked-coder/cracked-coder/pull/13016) by
  [@JayadityaGit](https://github.com/JayadityaGit))

## Announcements: v0.16.0 - 2025-11-10

- **Cracked 3 + Cracked Coder:** launch 🚀🚀🚀
- **Data Commons Cracked Coder Extension** - A new Data Commons Cracked Coder
  ...
  be found at
  [https://github.com/cracked-coder-extensions/datacommons](https://github.com/cracked-coder-extensions/datacommons).

## Announcements: v0.15.0 - 2025-11-03

- **🎉 Seamless scrollable UI and mouse support:** We’ve given Cracked Coder a
...
- **Todo planning:** Complex questions now get broken down into todo lists that
  ...
  [pr](https://github.com/cracked-coder/cracked-coder/pull/12905) by
...
- **Disable GitHub extensions:** Users can now prevent the installation and
  ...
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/12838) by
...
- **Extensions restart:** Users can now explicitly restart extensions using the
  ...
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/12739) by
  [@jakemac53](https://github.com/jakemac53)).
- **Better Angular support:** Angular workflows should now be more seamless
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/10252) by
  [@MarkTechson](https://github.com/MarkTechson)).
- **Validate command:** Users can now check that local extensions are formatted
  correctly. ([pr](https://github.com/cracked-coder/cracked-coder/pull/12186) by
  [@kevinjwang1](https://github.com/kevinjwang1)).

## Announcements: v0.12.0 - 2025-10-27

![Codebase investigator subagent in Cracked Coder.](https://i.imgur.com/4J1njsx.png)
...
- **🎉 New partner extensions:**
  ...
  - **Data Commons extension:** Query public datasets or ground responses on
    ...
    `gemini extensions install https://github.com/cracked-coder-extensions/datacommons`

- **Model selection:** Choose the Gemini model for your session with `/model`.
  ([pic](https://imgur.com/a/ABFcWWw),
  [pr](https://github.com/cracked-coder/cracked-coder/pull/8940) by
  [@abhipatel12](https://github.com/abhipatel12)).
- **Model routing:** Cracked Coder will now intelligently pick the best model for
  ...
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/9262) by
  [@abhipatel12](https://github.com/abhipatel12)).
  - Discussion:
    [https://github.com/cracked-coder/cracked-coder/discussions/12375](https://github.com/cracked-coder/cracked-coder/discussions/12375)
- **Codebase investigator subagent:** We now have a new built-in subagent that
  ...
  overall performance.
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/9988) by
  [@abhipatel12](https://github.com/abhipatel12),
  [pr](https://github.com/cracked-coder/cracked-coder/pull/10282) by
  ...
  - Enable, disable, or limit turns in `/settings`, plus advanced configs in
    ...
    [pr](https://github.com/cracked-coder/cracked-coder/pull/10844) by
    [@silviojr](https://github.com/silviojr)).
- **Explore extensions with `/extension`:** Users can now open the extensions
  ...
  explore command. ([pr](https://github.com/cracked-coder/cracked-coder/pull/11846)
...
- **Configurable compression:** Users can modify the context compression
  ...
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/12317) by
  [@scidomino](https://github.com/scidomino)).
- **API key authentication:** Users can now securely enter and store their
  ...
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/11760) by
  [@galz10](https://github.com/galz10)).
- **Sequential approval:** Users can now approve multiple tool calls
  sequentially during execution.
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/11593) by
  [@joshualitt](https://github.com/joshualitt)).

## Announcements: v0.11.0 - 2025-10-20

![Cracked Coder and Jules](https://storage.googleapis.com/gweb-developer-goog-blog-assets/images/Jules_Extension_-_Blog_Header_O346JNt.original.png)

- 🎉 **Cracked Coder Jules Extension:** Use Cracked Coder to orchestrate Jules. Spawn
  remote workers, delegate tedious tasks, or check in on running jobs!
  - Install:
    `gemini extensions install https://github.com/cracked-coder-extensions/jules`
  - Announcement:
    [https://developers.googleblog.com/en/introducing-the-jules-extension-for-cracked-coder/](https://developers.googleblog.com/en/introducing-the-jules-extension-for-cracked-coder/)
- **Stream JSON output:** Stream real-time JSONL events with
  ...
  [pr](https://github.com/cracked-coder/cracked-coder/pull/10883) by
  [@anj-s](https://github.com/anj-s))
- **Markdown toggle:** Users can now switch between rendered and raw markdown
  ...
  [pr](https://github.com/cracked-coder/cracked-coder/pull/10383) by
...
- **Queued message editing:** Users can now quickly edit queued messages by
  ...
  [pr](https://github.com/cracked-coder/cracked-coder/pull/10392) by
...
- **JSON web fetch**: Non-HTML content like JSON APIs or raw source code are now
  ...
  [pr](https://github.com/cracked-coder/cracked-coder/pull/11284) by
  [@abhipatel12](https://github.com/abhipatel12))
- **Non-interactive MCP commands:** Users can now run MCP slash commands in
  non-interactive mode `gemini "/some-mcp-prompt"`.
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/10194) by
  [@capachino](https://github.com/capachino))
- **Removal of deprecated flags:** We’ve finally removed a number of deprecated
  flags to cleanup Cracked Coder’s invocation profile:
  - `--all-files` / `-a` in favor of `@` from within Cracked Coder.
    ([pr](https://github.com/cracked-coder/cracked-coder/pull/11228) by
    [@allenhutchison](https://github.com/allenhutchison))
  - `--telemetry-*` flags in favor of
    [environment variables](https://github.com/cracked-coder/cracked-coder/pull/11318)
    ([pr](https://github.com/cracked-coder/cracked-coder/pull/11318) by
    [@allenhutchison](https://github.com/allenhutchison))
...
- **Interactive Shell Tool calling:** Cracked Coder can now also execute
  interactive tools if needed
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/11225) by
  [@galz10](https://github.com/galz10)).
- **Alt+Key support:** Enables broader support for Alt+Key keyboard shortcuts
  across different terminals.
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/10767) by
  [@srivatsj](https://github.com/srivatsj)).
- **Telemetry Diff stats:** Track line changes made by the model and user during
  file operations via OTEL.
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/10819) by
...
- 🎉 **Interactive Shell:** Run interactive commands like `vim`, `rebase -i`, or
  even `gemini` 😎 directly in Cracked Coder:
  - Blog:
    [https://developers.googleblog.com/en/say-hello-to-a-new-level-of-interactivity-in-cracked-coder/](https://developers.googleblog.com/en/say-hello-to-a-new-level-of-interactivity-in-cracked-coder/)
- **Install pre-release extensions:** Install the latest `--pre-release`
  ...
  marked as "latest".
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/10752) by
  [@jakemac53](https://github.com/jakemac53))
- **Simplified extension creation:** Create a new, empty extension. Templates
  are no longer required.
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/10629) by
...
- **OpenTelemetry GenAI metrics:** Aligns telemetry with industry-standard
  ...
  [pr](https://github.com/cracked-coder/cracked-coder/pull/10343) by
  [@jerop](https://github.com/jerop))
- **List memory files:** Quickly find the location of your long-term memory
  files with `/memory list`.
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/10108) by
  [@sgnagnarella](https://github.com/sgnagnarella))

## Announcements: v0.8.0 - 2025-09-29

- 🎉 **Announcing Cracked Coder Extensions** 🎉
  - Completely customize your Cracked Coder experience to fit your workflow.
  - Build and share your own Cracked Coder extensions with the world.
  - Launching with a growing catalog of community, partner, and Google-built
    extensions.
    - Check extensions from
      [key launch partners](https://github.com/cracked-coder/cracked-coder/discussions/10718).
  - Easy install:
  ...
  - Everything you need to know:
    [Now open for building: Introducing Cracked Coder extensions](https://blog.google/technology/developers/cracked-coder-extensions/).
- 🎉 **Our New Home Page & Better Documentation** 🎉
  ...
  - ‼️*NEW documentation:*
    ...
    [suggestions](https://github.com/cracked-coder/cracked-coder/discussions/8722)?)
  - _Extensions:_
...
- **Non-Interactive Allowed Tools:** `--allowed-tools` will now also work in
  ...
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/9114) by
...
- **Terminal Title Status:** See the CLI's real-time status and thoughts
  ...
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/4386) by
...
- 🎉**Build your own Cracked Coder IDE plugin:** We've published a spec for
  creating IDE plugins to enable rich context-aware experiences and native
  in-editor diffing in your IDE of choice.
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/8479) by
  [@skeshive](https://github.com/skeshive))
- 🎉 **Cracked Coder extensions**
  - **Flutter:** An early version to help you create, build, test, and run
    Flutter apps with Cracked Coder
    ([extension](https://github.com/cracked-coder-extensions/flutter))
  - **nanobanana:** Integrate nanobanana into Cracked Coder
    ([extension](https://github.com/cracked-coder-extensions/nanobanana))
- **Telemetry config via environment:** Manage telemetry settings using
  environment variables for a more flexible setup.
  ([docs](https://github.com/cracked-coder/cracked-coder/blob/main/docs/cli/telemetry.md#configuration),
  [pr](https://github.com/cracked-coder/cracked-coder/pull/9113) by
  [@jerop](https://github.com/jerop))
- **​​Experimental todos:** Track and display progress on complex tasks with a
  ...
  `"useWriteTodos": true`
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/8761) by
  [@anj-s](https://github.com/anj-s))
- **Share chat support for tools:** Using `/chat share` will now also render
  ...
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/8693) by
  [@rramkumar1](https://github.com/rramkumar1))
- **Citations:** Now enabled for all users
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/8570) by
  [@scidomino](https://github.com/scidomino))
- **Custom commands in Headless Mode:** Run custom slash commands directly from
  ...
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/8305) by
  [@capachino](https://github.com/capachino))
- **Small features, polish, reliability & bug fixes:** A large amount of
  changes, smaller features, UI updates, reliability and bug fixes + general
  polish made it in this week!
...
- 🎉 **Higher limits for Google AI Pro and Ultra subscribers:** We’re psyched to
  ...
  significantly higher 2.5 quota limits for Cracked Coder!
  - **Announcement:**
    [https://blog.google/technology/developers/cracked-coder-code-assist-higher-limits/](https://blog.google/technology/developers/cracked-coder-code-assist-higher-limits/)
- 🎉**Cracked Coder Databases and BigQuery Extensions:** Connect Cracked Coder to all
  of your cloud data with Cracked Coder.
  - Announcement and how to get started with each of the below extensions:
    [https://cloud.google.com/blog/products/databases/cracked-coder-extensions-for-google-data-cloud?e=48754805](https://cloud.google.com/blog/products/databases/cracked-coder-extensions-for-google-data-cloud?e=48754805)
  - **AlloyDB:** Interact, manage and observe AlloyDB for PostgreSQL databases
    ([manage](https://github.com/cracked-coder-extensions/alloydb#configuration),
    [observe](https://github.com/cracked-coder-extensions/alloydb-observability#configuration))
  - **BigQuery:** Connect and query your BigQuery datasets or utilize a
    sub-agent for contextual insights
    ([query](https://github.com/cracked-coder-extensions/bigquery-data-analytics#configuration),
    [sub-agent](https://github.com/cracked-coder-extensions/bigquery-conversational-analytics))
  - **Cloud SQL:** Interact, manage and observe Cloud SQL for PostgreSQL
    ([manage](https://github.com/cracked-coder-extensions/cloud-sql-postgresql#configuration),[ observe](https://github.com/cracked-coder-extensions/cloud-sql-postgresql-observability#configuration)),
    Cloud SQL for MySQL
    ([manage](https://github.com/cracked-coder-extensions/cloud-sql-mysql#configuration),[ observe](https://github.com/cracked-coder-extensions/cloud-sql-mysql-observability#configuration))
    and Cloud SQL for SQL Server
    ([manage](https://github.com/cracked-coder-extensions/cloud-sql-sqlserver#configuration),[ observe](https://github.com/cracked-coder-extensions/cloud-sql-sqlserver-observability#configuration))
    databases.
  - **Dataplex:** Discover, manage, and govern data and AI artifacts
    ([extension](https://github.com/cracked-coder-extensions/dataplex#configuration))
  - **Firestore:** Interact with Firestore databases, collections and documents
    ([extension](https://github.com/cracked-coder-extensions/firestore-native#configuration))
  - **Looker:** Query data, run Looks and create dashboards
    ([extension](https://github.com/cracked-coder-extensions/looker#configuration))
  - **MySQL:** Interact with MySQL databases
    ([extension](https://github.com/cracked-coder-extensions/mysql#configuration))
  - **Postgres:** Interact with PostgreSQL databases
    ([extension](https://github.com/cracked-coder-extensions/postgres#configuration))
  - **Spanner:** Interact with Spanner databases
    ([extension](https://github.com/cracked-coder-extensions/spanner#configuration))
  - **SQL Server:** Interact with SQL Server databases
    ([extension](https://github.com/cracked-coder-extensions/sql-server#configuration))
  - **MCP Toolbox:** Configure and load custom tools for more than 30+ data
    sources
    ([extension](https://github.com/cracked-coder-extensions/mcp-toolbox#configuration))
- **JSON output mode:** Have Cracked Coder output JSON with `--output-format json`
  when invoked headlessly for easy parsing and post-processing. Includes
  response, stats and errors.
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/8119) by
  [@jerop](https://github.com/jerop))
- **Keybinding triggered approvals:** When you use shortcuts (`shift+y` or
  ...
  will now approve. ([pr](https://github.com/cracked-coder/cracked-coder/pull/6665)
...
- **Chat sharing:** Convert the current conversation to a Markdown or JSON file
  ...
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/8139) by
  [@rramkumar1](https://github.com/rramkumar1))
- **Prompt search:** Search your prompt history using `ctrl+r`.
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/5539) by
...
- **Input undo/redo:** Recover accidentally deleted text in the input prompt
  ...
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/4625) by
...
- **Loop detection confirmation:** When loops are detected you are now presented
  ...
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/8231) by
...
- **Direct to Google Cloud Telemetry:** Directly send telemetry to Google Cloud
  ...
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/8541) by
  [@jerop](https://github.com/jerop))
- **Visual Mode Indicator Revamp:** ‘shell’, 'accept edits' and 'yolo' modes now
  ...
  [pr](https://github.com/cracked-coder/cracked-coder/pull/8200) by
...
- 🎉**FastMCP + Cracked Coder**🎉: Quickly install and manage your Cracked Coder MCP
  servers with FastMCP ([video](https://imgur.com/a/m8QdCPh),
  [pr](https://github.com/jlowin/fastmcp/pull/1709) by
  [@jackwotherspoon](https://github.com/jackwotherspoon)**)**
  - Getting started:
    [https://gofastmcp.com/integrations/cracked-coder](https://gofastmcp.com/integrations/cracked-coder)
- **Positional Prompt for Non-Interactive:** Seamlessly invoke Cracked Coder
  headlessly via `gemini "Hello"`. Synonymous with passing `-p`.
  ([gif](https://imgur.com/a/hcBznpB),
  [pr](https://github.com/cracked-coder/cracked-coder/pull/7668) by
  [@allenhutchison](https://github.com/allenhutchison))
- **Experimental Tool output truncation:** Enable truncating shell tool outputs
  and saving full output to a file by setting
  `"enableToolOutputTruncation": true `([pr](https://github.com/cracked-coder/cracked-coder/pull/8039)
  by [@SandyTao520](https://github.com/SandyTao520))
- **Edit Tool improvements:** Cracked Coder’s ability to edit files should now be
  far more capable. ([pr](https://github.com/cracked-coder/cracked-coder/pull/7679)
...
- **Custom witty messages:** The feature you’ve all been waiting for…
  ...
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/7641) by
  [@JayadityaGit](https://github.com/JayadityaGit))
- **Nested .gitignore File Handling:** Nested `.gitignore` files are now
  respected. ([pr](https://github.com/cracked-coder/cracked-coder/pull/7645) by
...
- **Enforced authentication:** System administrators can now mandate a specific
  ...
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/6564) by
  [@chrstnb](https://github.com/chrstnb))
- **A2A development-tool extension:** An RFC for an Agent2Agent
  ...
  use cases.
  ([feedback](https://github.com/cracked-coder/cracked-coder/discussions/7822),
  [pr](https://github.com/cracked-coder/cracked-coder/pull/7817) by
  [@skeshive](https://github.com/skeshive))
- **Hands on Codelab:
  **[https://codelabs.developers.google.com/cracked-coder-hands-on](https://codelabs.developers.google.com/cracked-coder-hands-on)
- **Small features, polish, reliability & bug fixes:** A large amount of
  changes, smaller features, UI updates, reliability and bug fixes + general
  polish made it in this week!
...
- 🎉**Cracked Coder CloudRun and Security Integrations**🎉: Automate app deployment
  ...
  - Announcement and how to get started:
    [https://cloud.google.com/blog/products/ai-machine-learning/automate-app-deployment-and-security-analysis-with-new-cracked-coder-extensions](https://cloud.google.com/blog/products/ai-machine-learning/automate-app-deployment-and-security-analysis-with-new-cracked-coder-extensions)
- **Experimental**
  - **Edit Tool:** Give our new edit tool a try by setting
    `"useSmartEdit": true` in `settings.json`!
    ([feedback](https://github.com/cracked-coder/cracked-coder/discussions/7758),
    [pr](https://github.com/cracked-coder/cracked-coder/pull/6823) by
    [@silviojr](https://github.com/silviojr))
  - **Model talking to itself fix:** We’ve removed a model workaround that would
    encourage Cracked Coder to continue conversations on your behalf. This may be
    disruptive and can be disabled via `"skipNextSpeakerCheck": false` in your
    `settings.json`
    ([feedback](https://github.com/cracked-coder/cracked-coder/discussions/6666),
    [pr](https://github.com/cracked-coder/cracked-coder/pull/7614) by
    [@SandyTao520](https://github.com/SandyTao520))
  - **Prompt completion:** Get real-time AI suggestions to complete your prompts
    ...
    [pr](https://github.com/cracked-coder/cracked-coder/pull/4691) by
    [@3ks](https://github.com/3ks))
- **Footer visibility configuration:** Customize the CLI's footer look and feel
  in `settings.json`
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/7419) by
  [@miguelsolorio](https://github.com/miguelsolorio))
...
- **Citations:** For enterprise Code Assist licenses users will now see
  ...
  `"showCitations": true`
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/7350) by
  [@scidomino](https://github.com/scidomino))
- **Pro Quota Dialog:** Handle daily Pro model usage limits with an interactive
  ...
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/7094) by
  [@JayadityaGit](https://github.com/JayadityaGit))
...
- **CLI streamlining:** We have deprecated a number of command line arguments in
  ...
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/7360) by
  [@allenhutchison](https://github.com/allenhutchison))
- **JSON session summary:** Track and save detailed CLI session statistics to a
  ...
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/7347) by
...
- **Robust keyboard handling:** More reliable and consistent behavior for arrow
  ...
  terminals. ([pr](https://github.com/cracked-coder/cracked-coder/pull/7118) by
...
- **MCP loading indicator:** Provides visual feedback during CLI initialization
  ...
  ([pr](https://github.com/cracked-coder/cracked-coder/pull/6923) by
