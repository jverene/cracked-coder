...
- fix(patch): cherry-pick 8432bce to release/v0.33.0-pr-22069 to patch version
  v0.33.0 and create version 0.33.1 by @cracked-coder-robot in
  [#22206](https://github.com/cracked-coder/cracked-coder/pull/22206)
- Docs: Update model docs to remove Preview Features. by @jkcinouye in
  [#20084](https://github.com/cracked-coder/cracked-coder/pull/20084)
- docs: fix typo in installation documentation by @AdityaSharma-Git3207 in
  [#20153](https://github.com/cracked-coder/cracked-coder/pull/20153)
- docs: add Windows PowerShell equivalents for environments and scripting by
  @scidomino in [#20333](https://github.com/cracked-coder/cracked-coder/pull/20333)
- fix(core): parse raw ASCII buffer strings in Gaxios errors by @sehoon38 in
  [#20626](https://github.com/cracked-coder/cracked-coder/pull/20626)
- chore(release): bump version to 0.33.0-nightly.20260227.ba149afa0 by @galz10
  in [#20637](https://github.com/cracked-coder/cracked-coder/pull/20637)
- fix(github): use robot PAT for automated PRs to pass CLA check by @galz10 in
  [#20641](https://github.com/cracked-coder/cracked-coder/pull/20641)
- chore/release: bump version to 0.33.0-nightly.20260228.1ca5c05d0 by
  @cracked-coder-robot in
  [#20644](https://github.com/cracked-coder/cracked-coder/pull/20644)
- Changelog for v0.31.0 by @cracked-coder-robot in
  [#20634](https://github.com/cracked-coder/cracked-coder/pull/20634)
- fix: use full paths for ACP diff payloads by @JagjeevanAK in
  [#19539](https://github.com/cracked-coder/cracked-coder/pull/19539)
- Changelog for v0.32.0-preview.0 by @cracked-coder-robot in
  [#20627](https://github.com/cracked-coder/cracked-coder/pull/20627)
- fix: acp/zed race condition between MCP initialisation and prompt by
  @kartikangiras in
  [#20205](https://github.com/cracked-coder/cracked-coder/pull/20205)
- fix(cli): reset themeManager between tests to ensure isolation by
  @NTaylorMullen in
  [#20598](https://github.com/cracked-coder/cracked-coder/pull/20598)
- refactor(core): Extract tool parameter names as constants by @SandyTao520 in
  [#20460](https://github.com/cracked-coder/cracked-coder/pull/20460)
- fix(cli): resolve autoThemeSwitching when background hasn't changed but theme
  mismatches by @sehoon38 in
  [#20706](https://github.com/cracked-coder/cracked-coder/pull/20706)
- feat(skills): add github-issue-creator skill by @sehoon38 in
  [#20709](https://github.com/cracked-coder/cracked-coder/pull/20709)
- fix(cli): allow sub-agent confirmation requests in UI while preventing
  background flicker by @abhipatel12 in
  [#20722](https://github.com/cracked-coder/cracked-coder/pull/20722)
- Merge User and Agent Card Descriptions #20849 by @adamfweidman in
  [#20850](https://github.com/cracked-coder/cracked-coder/pull/20850)
- fix(core): reduce LLM-based loop detection false positives by @SandyTao520 in
  [#20701](https://github.com/cracked-coder/cracked-coder/pull/20701)
- fix(plan): deflake plan mode integration tests by @Adib234 in
  [#20477](https://github.com/cracked-coder/cracked-coder/pull/20477)
- Add /unassign support by @scidomino in
  [#20864](https://github.com/cracked-coder/cracked-coder/pull/20864)
- feat(core): implement HTTP authentication support for A2A remote agents by
  @SandyTao520 in
  [#20510](https://github.com/cracked-coder/cracked-coder/pull/20510)
- feat(core): centralize read_file limits and update gemini-3 description by
  @aishaneeshah in
  [#20619](https://github.com/cracked-coder/cracked-coder/pull/20619)
- Do not block CI on evals by @gundermanc in
  [#20870](https://github.com/cracked-coder/cracked-coder/pull/20870)
- document node limitation for shift+tab by @scidomino in
  [#20877](https://github.com/cracked-coder/cracked-coder/pull/20877)
- Add install as an option when extension is selected. by @DavidAPierce in
  [#20358](https://github.com/cracked-coder/cracked-coder/pull/20358)
- Update CODEOWNERS for README.md reviewers by @g-samroberts in
  [#20860](https://github.com/cracked-coder/cracked-coder/pull/20860)
- feat(core): truncate large MCP tool output by @SandyTao520 in
  [#19365](https://github.com/cracked-coder/cracked-coder/pull/19365)
- Subagent activity UX. by @gundermanc in
  [#17570](https://github.com/cracked-coder/cracked-coder/pull/17570)
- style(cli) : Dialog pattern for /hooks Command by @AbdulTawabJuly in
  [#17930](https://github.com/cracked-coder/cracked-coder/pull/17930)
- feat: redesign header to be compact with ASCII icon by @keithguerin in
  [#18713](https://github.com/cracked-coder/cracked-coder/pull/18713)
- fix(core): ensure subagents use qualified MCP tool names by @abhipatel12 in
  [#20801](https://github.com/cracked-coder/cracked-coder/pull/20801)
- feat(core): support authenticated A2A agent card discovery by @SandyTao520 in
  [#20622](https://github.com/cracked-coder/cracked-coder/pull/20622)
...
- fix(patch): cherry-pick 0659ad1 to release/v0.33.0-preview.0-pr-21042 to patch
  ...
  @cracked-coder-robot in
  [#21047](https://github.com/cracked-coder/cracked-coder/pull/21047)
- fix(patch): cherry-pick 173376b to release/v0.33.0-preview.1-pr-21157 to patch
  ...
  @cracked-coder-robot in
  [#21300](https://github.com/cracked-coder/cracked-coder/pull/21300)
- fix(patch): cherry-pick 0135b03 to release/v0.33.0-preview.2-pr-21171
  [CONFLICTS] by @cracked-coder-robot in
  [#21336](https://github.com/cracked-coder/cracked-coder/pull/21336)
- fix(patch): cherry-pick 7ec477d to release/v0.33.0-preview.3-pr-21305 to patch
  ...
  @cracked-coder-robot in
  [#21349](https://github.com/cracked-coder/cracked-coder/pull/21349)
- fix(patch): cherry-pick 931e668 to release/v0.33.0-preview.4-pr-21425
  [CONFLICTS] by @cracked-coder-robot in
  [#21478](https://github.com/cracked-coder/cracked-coder/pull/21478)
- fix(patch): cherry-pick 7837194 to release/v0.33.0-preview.5-pr-21487 to patch
  ...
  @cracked-coder-robot in
  [#21720](https://github.com/cracked-coder/cracked-coder/pull/21720)
- fix(patch): cherry-pick 4f4431e to release/v0.33.0-preview.7-pr-21750 to patch
  ...
  @cracked-coder-robot in
  [#21782](https://github.com/cracked-coder/cracked-coder/pull/21782)
- fix(patch): cherry-pick 9a74271 to release/v0.33.0-preview.8-pr-21236
  [CONFLICTS] by @cracked-coder-robot in
  [#21788](https://github.com/cracked-coder/cracked-coder/pull/21788)
- fix(patch): cherry-pick 936f624 to release/v0.33.0-preview.9-pr-21702 to patch
  ...
  @cracked-coder-robot in
  [#21800](https://github.com/cracked-coder/cracked-coder/pull/21800)
- fix(patch): cherry-pick 35ee2a8 to release/v0.33.0-preview.10-pr-21713 by
  @cracked-coder-robot in
  [#21859](https://github.com/cracked-coder/cracked-coder/pull/21859)
- fix(patch): cherry-pick 5dd2dab to release/v0.33.0-preview.11-pr-21871 by
  @cracked-coder-robot in
  [#21876](https://github.com/cracked-coder/cracked-coder/pull/21876)
- fix(patch): cherry-pick e5615f4 to release/v0.33.0-preview.12-pr-21037 to
  ...
  @cracked-coder-robot in
  [#21922](https://github.com/cracked-coder/cracked-coder/pull/21922)
- fix(patch): cherry-pick 1b69637 to release/v0.33.0-preview.13-pr-21467
  [CONFLICTS] by @cracked-coder-robot in
  [#21930](https://github.com/cracked-coder/cracked-coder/pull/21930)
- fix(patch): cherry-pick 3ff68a9 to release/v0.33.0-preview.14-pr-21884
  [CONFLICTS] by @cracked-coder-robot in
  [#21952](https://github.com/cracked-coder/cracked-coder/pull/21952)

**Full Changelog**:
https://github.com/cracked-coder/cracked-coder/compare/v0.32.1...v0.33.1
