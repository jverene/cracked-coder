...
problems encountered while using Cracked Coder.

## General issues

This section addresses common questions about Cracked Coder usage, security, and
troubleshooting general errors.

### Why can't I use third-party software (e.g. Claude Code, OpenClaw, OpenCode) with Cracked Coder?
...
your total token usage using the `/stats` command in Cracked Coder.

## Installation and updates

### How do I update Cracked Coder to the latest version?

If you installed it globally via `npm`, update it using the command
`npm install -g @google/cracked-coder@latest`. If you compiled it from source, pull
...
- **Use a `.env` file:** Create a `.env` file in your project's `.cracked`
  directory (`.cracked/.env`) and store your keys there. Cracked Coder will
...
### Where are the Cracked Coder configuration and settings files stored?

The Cracked Coder configuration is stored in two `settings.json` files:

1.  In your home directory: `~/.cracked/settings.json`.
2.  In your project's root directory: `./.cracked/settings.json`.

Refer to [Cracked Coder Configuration](../reference/configuration.md) for more
details.
...
limits to Gemini Code Assist and Cracked Coder. These are shared across Cracked Coder
...
### What is the privacy policy for using Gemini Code Assist or Cracked Coder if I've subscribed to Google AI Pro or Ultra?
...
The higher limits in your Google AI Pro or Ultra subscription are for Cracked 2.5
across both Cracked 2.5 Pro and Flash. They are shared quota across Cracked Coder
and agent mode in Gemini Code Assist IDE extensions. You can learn more about
quota limits for Cracked Coder, Gemini Code Assist and agent mode in Gemini Code
Assist at
[Quotas and limits](https://developers.google.com/gemini-code-assist/resources/quotas).

### If I upgrade to higher limits for Cracked Coder and Gemini Code Assist by purchasing a Google AI Pro or Ultra subscription, will Gemini start using my data to improve its machine learning models?
...
Search the
[Cracked Coder Q&A discussions on GitHub](https://github.com/cracked-coder/cracked-coder/discussions/categories/q-a)
or
[start a new discussion on GitHub](https://github.com/cracked-coder/cracked-coder/discussions/new?category=q-a)
