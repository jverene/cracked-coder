...
This document provides the technical specification for Cracked Coder hooks,
...
Cracked Coder uses these structures to ensure hooks don't break across SDK updates.
