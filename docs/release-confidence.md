...
the Cracked Coder. It serves as a checklist and quality gate for release manager to
...
- **Command:** `npx -y @google/cracked-coder@<tag> --version` must return the
...
- **Setup:**
  ...
  - [ ] Install the preview version: `npm install -g @google/cracked-coder@preview`
  - [ ] Verify version: `cracked --version`
...
- [ ] Navigate to `go/cracked-coder-offline-evals-dash`.
