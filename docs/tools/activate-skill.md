...
The `activate_skill` tool lets Cracked Coder load specialized procedural expertise
...
tasks, such as reviewing code or creating pull requests. Cracked Coder uses this
