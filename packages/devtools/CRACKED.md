# Cracked Coder DevTools

Integrated Developer Tools for Cracked Coder, providing a Chrome DevTools-like
...
| -------------------------------- | --------------------------------------------- |
| `CRACKED_CODER_ACTIVITY_LOG_TARGET` | File path for JSONL mode (optional, fallback) |
