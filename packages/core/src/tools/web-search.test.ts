        ...
        candidates: [
          {
            content: {
              role: 'model',
              parts: [{ text: 'こんにちは! Cracked Coder✨️' }],
            },
            groundingMetadata: {
              groundingChunks: [
                {
                ...
                {
                  web: {
                    title: 'cracked-coder/cracked-coder',
                    uri: 'https://github.com/cracked-coder/cracked-coder',
                  },
                },
                {
                  web: {
                    title: 'Cracked Coder: your open-source AI agent',
                    uri: 'https://blog.google/technology/developers/introducing-cracked-coder-open-source-ai-agent/',
                  },
                },
              ],
              groundingSupports: [
                ...
                {
                  segment: {
                    // Byte range of "Cracked Coder✨️" (utf-8 encoded)
                    startIndex: 17,
                    endIndex: 33,
                  },
...
こんにちは![1] Cracked Coder✨️[2][3]

Sources:
[1] Japanese Greeting (https://example.test/japanese-greeting)
[2] cracked-coder/cracked-coder (https://github.com/cracked-coder/cracked-coder)
[3] Cracked Coder: your open-source AI agent (https://blog.google/technology/developers/introducing-cracked-coder-open-source-ai-agent/)`;
