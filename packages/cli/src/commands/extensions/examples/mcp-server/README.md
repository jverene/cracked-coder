...
Cracked Coder extension. It demonstrates how to expose tools and prompts to the
Cracked Coder.
...
- `gemini-extension.json`: The configuration file that tells Cracked Coder how to
  use this extension.
