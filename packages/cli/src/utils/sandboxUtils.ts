...
import { debugLogger, CRACKED_DIR } from '@cracked-coder/core';

export const LOCAL_DEV_SANDBOX_IMAGE_NAME = 'cracked-coder-sandbox';
export const SANDBOX_NETWORK_NAME = 'cracked-coder-sandbox';
export const SANDBOX_PROXY_NAME = 'cracked-coder-sandbox-proxy';
...
export function entrypoint(workdir: string, cliArgs: string[]): string[] {
  ...
  const projectSandboxBashrc = `${CRACKED_DIR}/sandbox.bashrc`;
