...
export const INFORMATIVE_TIPS = [
  ...
  'Toggle respect for .crackedignore files in context (/settings)…',
  ...
  'Show Cracked Coder status in the terminal window title (/settings)…',
  ...
  'Create a project-specific CRACKED.md file with /init…',
  ...
  'Reload instructional context from CRACKED.md files with /memory reload…',
  'List the paths of the CRACKED.md files in use with /memory list…',
