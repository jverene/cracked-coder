...
import { getVersion } from '@cracked-coder/core';
...
* **IDE Client:** VSCode
`;
    const expectedUrl = `https://github.com/cracked-coder/cracked-coder/issues/new?template=bug_report.yml&title=A%20test%20bug&info=${encodeURIComponent(expectedInfo)}&problem=A%20test%20bug`;
