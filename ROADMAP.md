# Cracked Coder Roadmap

The
[Official Cracked Coder Roadmap](https://github.com/orgs/cracked-coder/projects/11/)

Cracked Coder is an open-source AI agent that brings the power of Gemini directly
into your terminal. It provides lightweight access to Gemini, giving you the
most direct path from your prompt to our model.

This document outlines our approach to the Cracked Coder roadmap. Here, you'll find
...
As an
[Apache 2.0 open source project](https://github.com/cracked-coder/cracked-coder?tab=Apache-2.0-1-ov-file#readme),
we appreciate and welcome
[public contributions](https://github.com/cracked-coder/cracked-coder/blob/main/CONTRIBUTING.md),
...
[opening an issue for discussion](https://github.com/cracked-coder/cracked-coder/issues/new/choose).
...
- **Intelligent:** Cracked Coder should be reliably ranked among the best agentic
...
Roadmap Issue [here](https://github.com/cracked-coder/cracked-coder/issues/4191).
...
all our items [here](https://github.com/orgs/cracked-coder/projects/11/views/19)
...
- **Extensibility:** Bringing Cracked Coder to other surfaces e.g. GitHub.
...
Cracked Coder is an open-source project, and we welcome contributions from the
community! Whether you're a developer, a designer, or just an enthusiastic user
you can find our
[Community Guidelines here](https://github.com/cracked-coder/cracked-coder/blob/main/CONTRIBUTING.md)
to learn how to get started. There are many ways to get involved:

- **Roadmap:** Please review and find areas in our
  [roadmap](https://github.com/cracked-coder/cracked-coder/issues/4191) that you
...
- **Report Bugs:** If you find an issue, please create a
  [bug](https://github.com/cracked-coder/cracked-coder/issues/new?template=bug_report.yml)
...
- **Suggest Features:** Have a great idea? We'd love to hear it! Open a
  [feature request](https://github.com/cracked-coder/cracked-coder/issues/new?template=feature_request.yml).
- **Contribute Code:** Check out our
  [CONTRIBUTING.md](https://github.com/cracked-coder/cracked-coder/blob/main/CONTRIBUTING.md)
...
- **Write Documentation:** Help us improve our documentation, tutorials, and
  examples. We are excited about the future of Cracked Coder and look forward to
